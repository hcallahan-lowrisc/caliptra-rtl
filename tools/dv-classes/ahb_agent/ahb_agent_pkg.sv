...
package ahb_agent_pkg;
  ...
  // A structure representing a some address range and a particular subordinate index. A queue of
  // these structures defines a partial map from address to subordinate index (take the first item
