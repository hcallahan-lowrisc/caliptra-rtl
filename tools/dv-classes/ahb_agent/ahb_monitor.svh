...
task ahb_monitor::watch_until_reset();
  ...
  forever begin
    ...
    if (req_item != null) begin
      ...
      bit [127:0]           wstrb_from_size = (1 << (1 << req_item.m_size)) - 1;
      ...
      req_item.m_wdata = m_vif.mon_cb.hwdata;
      req_item.m_wstrb = m_vif.has_write_strobes ? m_vif.mon_cb.hwstrb : wstrb_from_size;
      ...
      rsp_item.m_rdata = m_vif.mon_cb.hrdata[selected_idx];
